      ...
      <Box className={styles.listWrapper}>
        <List>
          <ListItem disablePadding className={styles.listItem}>
            <ListItemButton>
              <ListItemIcon>
                <CastleIcon className={styles.listItemIcon}/>
              </ListItemIcon>
          ...
          <ListItem disablePadding className={styles.listItem}>
            <ListItemButton>
              <ListItemIcon>
                <PeopleAltIcon className={styles.listItemIcon}/>
              </ListItemIcon>
          ...
          <ListItem disablePadding className={styles.listItem}>
            <ListItemButton>
              <ListItemIcon>
                <PersonIcon className={styles.listItemIcon}/>
              </ListItemIcon>
        ...
        <Box sx={{ margin: "auto 0 0 0", display: "flex", justifyContent: "center", alignItems: "center", padding: "20px", gap: "10px" }}>
